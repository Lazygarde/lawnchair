 ...
 */
// withoutQuickstep variant: replaced BaseDepthController.DEPTH_60_PERCENT with 0.6f literal,
// wrapped InteractionJankMonitorWrapper calls in try/catch(Throwable).
...
/**
 * Definition for AllApps state — withoutQuickstep variant.
 */
public class AllAppsState extends LauncherState {
    ...
    // Literal replacement for BaseDepthController.DEPTH_60_PERCENT (0.6f) — avoids quickstep dep.
    private static final float DEPTH_60_PERCENT = 0.6f;
    ...
    public void onBackStarted(Launcher launcher) {
        ...
        } catch (Throwable ignored) { /* non-SDK, Android 16+ enforcement */ }
    ...
    public void onBackInvoked(Launcher launcher) {
        ...
        } catch (Throwable ignored) { /* non-SDK */ }
